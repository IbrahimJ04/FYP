...
# Define GM System
def backward_euler_gm_system2(system, T, A_0, H_0, delta_t, delta_x, t_end, x_end, D_A, D_H, k=None, c=None):
...
### Equations (after rearranging equation of implicit scheme):
    ...
    for n in range(N_t - 1):  # Iterate over time
        ...
        if system == "GM 1 - With diffusion":
            ...
            b_H = H_old + delta_t * ((-H_old + A_old**2) / T)
...
### System of Equations to solve:
    ...
    # H_matrix * H[:, n+1] = b_H
        ...
        # Solve linear systems for A and H - what method does this solver use?
...
# Run the simulation
A, H, x_vals, t_vals = backward_euler_gm_system2(system, T, A_0, H_0, delta_t, delta_x, t_end, x_end, D_A, D_H, k, c)
